...
<Path d="M13.7831 59.2279C16.2952 59.2279 18.3317 57.1877 18.3317 54.6709C18.3317 52.1542 16.2952 50.114 13.7831 50.114C11.2709 50.114 9.23438 52.1542 9.23438 54.6709C9.23438 57.1877 11.2709 59.2279 13.7831 59.2279Z" fill="white"/>
              ...
              <Text style={[ProfileStyles.regisText, { marginTop: 13 }]}>
                Login
              </Text>
            </View>
            ...
            <View>
              <View style={ProfileStyles.headContainer}>
                ...
                >
                  Enter the email you use to login to Xero and we'll send you a
                  link to get you back into your account.
                </Text>
                <View>
                ...
                <TextInput
                  ...
                  onChangeText={(value) =>
                    setForgetForm({ ...forgetForm, email: value })
                  }
              ...
              <View>
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  >
                    <Text style={ProfileStyles.forgot_button}>
                      Back to login
                    </Text>
                  </TouchableOpacity>
                </View>
