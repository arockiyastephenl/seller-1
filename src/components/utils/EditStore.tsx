            ...
            <View style={[ProfileStyles.content]}>
              ...
              <View>
                {profilePic ? (
                  <TouchableOpacity
                    ...
                    style={ProfileStyles.profileUpload}
                  >
              ...
              <View>
                <View style={[ProfileStyles.headContainer]}>
                  <View>
                    <Text style={[ProfileStyles.headText]}>Store Name</Text>
                  </View>
                  <TextInput
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Category</Text>
                  </View>
        ...
        />   */}
                ...
                <View style={ProfileStyles.headContainer}>
                  ...
                  <TextInput
                    ...
                    numberOfLines={4}
                    multiline={true}
                    onBlur={() => DescriptionValidate(form.description)}
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Location</Text>
                  </View>
                  <SelectBox
                    style={[ProfileStyles.inputBox]}
                    placeholder="Store Category"
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Type</Text>
                  </View>
                  <TextInput
                    onChangeText={(value) =>
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Serving Location</Text>
                  </View>
                  <SelectBox
                    style={[ProfileStyles.inputBox]}
                    placeholder="Store Category"
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Email</Text>
                  </View>
                  <TextInput
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Country</Text>
                  </View>
                  <TextInput
                    onChangeText={(value) =>
                ...
                <View style={ProfileStyles.headContainer}>
                  <View>
                    <Text style={ProfileStyles.headText}>Store Contact</Text>
                  </View>
                  <TextInput
                    onChangeText={(value) =>
          ...
          <ScrollView style={styles.scrollView}>
            <View style={[ProfileStyles.content]}>
              ...
              <View>
                ...
                <View style={ProfileStyles.headContainer}>
                  <Text style={ProfileStyles.headText}>Upload Store Image</Text>
                ...
                <View style={ProfileStyles.headContainer}>
                  <Text style={ProfileStyles.headText}>Store Description</Text>

                  <TextInput
                    onChangeText={(value) =>
                      setForm({ ...form, description: value })
                    }
                    style={[ProfileStyles.inputBoxDesk, { height: 100 }]}
                    placeholder=" Store Description"
                    // secureTextEntry={true}
                    numberOfLines={4}
                    multiline={true}
